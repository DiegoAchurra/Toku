...
def simulate_round(hero1, hero2):
    ...
    while first_attacker_hp > 0 and second_attacker_hp > 0:
        ...
        if second_attacker_hp <= 0:
            ...
            print(f"And the battle continues... {first_attacker['name']} defeated {second_attacker['name']}!")
        ...
        if first_attacker_hp <= 0:
            ...
            print(f"And the battle continues... {second_attacker['name']} defeated {first_attacker['name']}!")
